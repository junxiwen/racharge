package com.hyanzz.wxpay;

import com.hyanzz.wxpay.WXPayConstants.SignType;
...
public class WXPay {
    ...
    private void checkWXPayConfig() throws Exception {
        if (this.config == null) {
            throw new Exception("static is null");
        }
        if (this.config.getAppID() == null || this.config.getAppID().trim().length() == 0) {
            throw new Exception("appid in static is empty");
        }
        if (this.config.getMchID() == null || this.config.getMchID().trim().length() == 0) {
            throw new Exception("appid in static is empty");
        }
        if (this.config.getCertStream() == null) {
            throw new Exception("cert stream in static is empty");
        }
        if (this.config.getWXPayDomain() == null){
            throw new Exception("static.getWXPayDomain() is null");
        }
